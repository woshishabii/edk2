...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1A7E4468, 0x2F55, 0x4a56, {0x90, 0x3C, 0x01, 0x26, 0x5E, 0xB7, 0x62, 0x2B}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TcpDxe";
...
{
  return TcpDriverEntryPoint (ImageHandle, SystemTable);
}
