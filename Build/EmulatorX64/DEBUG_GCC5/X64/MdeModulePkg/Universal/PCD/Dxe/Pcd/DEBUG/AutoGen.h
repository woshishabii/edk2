...
#define _PCD_TOKEN_PcdVpdBaseAddress  125U
...
#define PEI_LOCAL_TOKEN_NUMBER_TABLE_SIZE  8
#define PEI_LOCAL_TOKEN_NUMBER             8
...
#define DXE_STRING_TABLE_SIZE              28U
#define DXE_SKUID_TABLE_SIZE               1U
#define DXE_LOCAL_TOKEN_NUMBER_TABLE_SIZE  4
#define DXE_LOCAL_TOKEN_NUMBER             4
...
typedef struct {
  ...
  UINT8              StringTable[12]; /* PcdConOutColumn_a1aff049_fdeb_442a_b320_13ab4cb72bbc */
  UINT8              StringTable_1[16]; /* PcdPlatformBootTimeOut_914aebe7_4635_459b_aa1c_11e219b03a10 */
