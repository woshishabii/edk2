...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x5c1997d7, 0x8d45, 0x4f21, {0xaf, 0x3c, 0x22, 0x06, 0xb8, 0xed, 0x8b, 0xec}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PL061GpioDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEmbeddedGpioProtocolGuid = { 0x17a0a3d7, 0xc0a5, 0x4635, { 0xbb, 0xd5, 0x07, 0x21, 0x87, 0xdf, 0xe2, 0xee }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPlatformGpioProtocolGuid = { 0x52ce9845, 0x5af4, 0x43e2, {0xba, 0xfd, 0x23, 0x08, 0x12, 0x54, 0x7a, 0xc2 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPL061GpioBase = _PCD_VALUE_PcdPL061GpioBase;
...
#define _PCD_TOKEN_PcdMaximumDevicePathNodeCount  54U
...
#define _PCD_TOKEN_PcdDriverDiagnosticsDisable  52U
...
#define _PCD_TOKEN_PcdComponentNameDisable  48U
...
#define _PCD_TOKEN_PcdDriverDiagnostics2Disable  51U
...
#define _PCD_TOKEN_PcdComponentName2Disable  47U
...
#define _PCD_TOKEN_PcdUgaConsumeSupport  66U
...
#define _PCD_TOKEN_PcdUefiLibMaxPrintBufferSize  65U
...
{
  return PL061InstallProtocol (ImageHandle, SystemTable);
}
