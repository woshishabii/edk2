...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x89464DAE, 0x8DAA, 0x41FE, {0xA4, 0xC8, 0x40, 0xD2, 0x17, 0x5A, 0xF1, 0xE9}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "LcdGraphicsOutputDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdGopDisableOnExitBootServices = _PCD_VALUE_PcdGopDisableOnExitBootServices;
...
{
  return LcdGraphicsOutputDxeInitialize (ImageHandle, SystemTable);
}
