...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xebd705fb, 0xfa92, 0x46a7, {0xb3, 0x2b, 0x7f, 0x56, 0x6d, 0x94, 0x46, 0x14}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SP805WatchdogDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSP805WatchdogBase = _PCD_VALUE_PcdSP805WatchdogBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSP805WatchdogClockFrequencyInHz = _PCD_VALUE_PcdSP805WatchdogClockFrequencyInHz;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSP805WatchdogInterrupt = _PCD_VALUE_PcdSP805WatchdogInterrupt;
...
{
  return SP805Initialize (ImageHandle, SystemTable);
}
