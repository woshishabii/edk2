...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdAcpiS3Enable = _PCD_VALUE_PcdAcpiS3Enable;
...
#define _PCD_TOKEN_PcdS3BootScriptRuntimeTableReservePageNumber  124U
