...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9C1080EE, 0xD02E, 0x487f, {0x94, 0x32, 0xF3, 0xBF, 0x08, 0x6E, 0xC1, 0x80}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GenericMemoryTestDxe";
