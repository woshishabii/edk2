...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xb6f44cc0, 0x9e45, 0x11df, {0xbe, 0x21, 0x00, 0x02, 0xa5, 0xd5, 0xc5, 0x1b}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MmcDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEmbeddedMmcHostProtocolGuid = { 0x3e591c00, 0x9e4a, 0x11df, {0x92, 0x44, 0x00, 0x02, 0xA5, 0xD5, 0xC5, 0x1B }};
...
{
  return MmcDxeInitialize (ImageHandle, SystemTable);
}
