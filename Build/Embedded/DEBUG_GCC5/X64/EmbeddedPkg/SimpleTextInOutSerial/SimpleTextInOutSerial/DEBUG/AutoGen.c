...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6696936D, 0x3637, 0x467C, {0x87, 0xCB, 0x14, 0xEA, 0x82, 0x48, 0x94, 0x8C}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SimpleTextInOutSerial";
...
#define _PCD_TOKEN_PcdReportStatusCodePropertyMask  11U
...
{
  return SimpleTextInOutEntryPoint (ImageHandle, SystemTable);
}
