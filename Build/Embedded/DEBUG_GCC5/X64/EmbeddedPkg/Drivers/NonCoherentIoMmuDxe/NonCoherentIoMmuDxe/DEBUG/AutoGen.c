...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7ed510aa, 0x9cdc, 0x49d2, {0xa3, 0x06, 0x6e, 0x11, 0xe3, 0x59, 0xf9, 0xb3}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NonCoherentIoMmuDxe";
...
#define _PCD_VALUE_PcdDmaDeviceOffset  0x0ULL
...
#define _PCD_TOKEN_PcdDmaDeviceLimit  21U
#define _PCD_SIZE_PcdDmaDeviceLimit 8
#define _PCD_GET_MODE_SIZE_PcdDmaDeviceLimit  _PCD_SIZE_PcdDmaDeviceLimit 
#define _PCD_VALUE_PcdDmaDeviceLimit  0xFFFFFFFFFFFFFFFFULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdDmaDeviceLimit = _PCD_VALUE_PcdDmaDeviceLimit;
  ...
  )
{
  ...
  Status = NonCoherentDmaLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return NonCoherentIoMmuDxeEntryPoint (ImageHandle, SystemTable);
}
