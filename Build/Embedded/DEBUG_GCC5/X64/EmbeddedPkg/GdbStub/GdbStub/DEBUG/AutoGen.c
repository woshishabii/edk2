...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1F2CCB4F, 0xD817, 0x404E, {0x98, 0xE7, 0x80, 0xE4, 0x85, 0x1F, 0xB3, 0x3E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GdbStub";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdGdbMaxPacketRetryCount = _PCD_VALUE_PcdGdbMaxPacketRetryCount;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdGdbSerial = _PCD_VALUE_PcdGdbSerial;
...
#define _PCD_VALUE_PcdGdbBaudRate  115200ULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdGdbBaudRate = _PCD_VALUE_PcdGdbBaudRate;
...
#define _PCD_VALUE_PcdGdbDataBits  8U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdGdbDataBits = _PCD_VALUE_PcdGdbDataBits;
...
#define _PCD_VALUE_PcdGdbParity  1U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdGdbParity = _PCD_VALUE_PcdGdbParity;
...
#define _PCD_VALUE_PcdGdbStopBits  1U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdGdbStopBits = _PCD_VALUE_PcdGdbStopBits;
...
#define _PCD_VALUE_PcdGdbUartPort  0x3f8U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdGdbUartPort = _PCD_VALUE_PcdGdbUartPort;
  ...
  )
{
  ...
  Status = GdbSerialLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return GdbStubEntry (ImageHandle, SystemTable);
}
