...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0D1CE46B, 0x72D9, 0x4BA7, {0x95, 0xDA, 0x23, 0x51, 0x18, 0x65, 0xE6, 0x61}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0xE1063286, 0x6C8C, 0x4c25, {0xAE, 0xF0, 0x67, 0xA9, 0xA5, 0xB6, 0xE6, 0xB6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CryptoPei";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiCryptoPpiGuid = { 0x7DCE671B, 0xC223, 0x446A, { 0xA7, 0x05, 0xED, 0x63, 0x7A, 0xAF, 0x67, 0x71 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdCryptoServiceFamilyEnable[88] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff,0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x33,0x00,0x00,0x00,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdCryptoServiceFamilyEnable = 88;

// Definition of PCDs used in libraries

#define _PCD_TOKEN_PcdVerifyNodeInList  8U
...
#define _PCD_TOKEN_PcdSpeculationBarrierType  7U
...
{
  return CryptoPeiEntry (FileHandle, PeiServices);
}
