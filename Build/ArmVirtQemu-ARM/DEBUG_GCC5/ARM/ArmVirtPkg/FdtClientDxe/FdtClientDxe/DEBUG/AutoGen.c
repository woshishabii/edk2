...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9A871B00, 0x1C16, 0x4F61, {0x8D, 0x2C, 0x93, 0xB6, 0x65, 0x4B, 0x5A, 0xD6}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FdtClientDxe";
...
{
  return InitializeFdtClientDxe (ImageHandle, SystemTable);
}
