...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x63EA1463, 0xFBFA, 0x428A, {0xB9, 0x7F, 0xE2, 0x22, 0x75, 0x58, 0x52, 0xD7}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HighMemDxe";
...
{
  return InitializeHighMemDxe (ImageHandle, SystemTable);
}
