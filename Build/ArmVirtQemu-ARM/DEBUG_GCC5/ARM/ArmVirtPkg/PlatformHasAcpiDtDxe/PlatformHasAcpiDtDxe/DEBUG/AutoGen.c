...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9d1dd27f, 0x6d7f, 0x427b, {0xae, 0xc4, 0xb6, 0x2f, 0x62, 0x79, 0xc2, 0xf1}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PlatformHasAcpiDtDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiPlatformHasDeviceTreeGuid = { 0x7ebb920d, 0x1aaf, 0x46d9, { 0xb2, 0xaf, 0x54, 0x1e, 0x1d, 0xce, 0x14, 0x8b } };
...
{
  return PlatformHasAcpiDt (ImageHandle, SystemTable);
}
