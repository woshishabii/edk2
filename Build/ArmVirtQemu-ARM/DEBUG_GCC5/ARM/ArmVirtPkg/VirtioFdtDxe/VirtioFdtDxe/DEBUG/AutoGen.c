...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0049858F, 0x8CA7, 0x4CCD, {0x91, 0x8B, 0xD9, 0x52, 0xCB, 0xF3, 0x29, 0x75}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VirtioFdtDxe";
...
{
  return InitializeVirtioFdtDxe (ImageHandle, SystemTable);
}
