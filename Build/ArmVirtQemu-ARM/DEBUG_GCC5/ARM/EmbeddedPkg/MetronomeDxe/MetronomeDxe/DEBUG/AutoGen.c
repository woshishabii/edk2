...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4C6E0267, 0xC77D, 0x410D, {0x81, 0x00, 0x14, 0x95, 0x91, 0x1A, 0x98, 0x9D}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MetronomeDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdMetronomeTickPeriod = _PCD_VALUE_PcdMetronomeTickPeriod;
...
{
  return MetronomeInitialize (ImageHandle, SystemTable);
}
