...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB336F62D, 0x4135, 0x4A55, {0xAE, 0x4E, 0x49, 0x71, 0xBB, 0xF0, 0x88, 0x5D}};
...
#define _PCD_TOKEN_PcdPL031RtcBase  6U
...
#define _PCD_TOKEN_PcdPL031RtcPpmAccuracy  37U
...
#define _PCD_VALUE_PcdPL031RtcPpmAccuracy  300000000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPL031RtcPpmAccuracy = _PCD_VALUE_PcdPL031RtcPpmAccuracy;
  ...
  )
{
  ...
  Status = ArmVirtPL031FdtClientLibConstructor ();
  ASSERT_RETURN_ERROR (Status);
