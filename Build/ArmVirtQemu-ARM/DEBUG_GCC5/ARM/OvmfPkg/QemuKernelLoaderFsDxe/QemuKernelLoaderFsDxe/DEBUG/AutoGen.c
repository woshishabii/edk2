...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x806040ca, 0xdad9, 0x4978, {0xa3, 0xb4, 0x2d, 0x2a, 0xb0, 0xc8, 0xa4, 0x8f}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "QemuKernelLoaderFsDxe";
...
{
  return QemuKernelLoaderFsDxeEntrypoint (ImageHandle, SystemTable);
}
