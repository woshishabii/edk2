...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2f30da26, 0xf51b, 0x4b6f, {0x85, 0xc4, 0x31, 0x87, 0x3c, 0x28, 0x1b, 0xca}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "LinuxInitrdDynamicShellCommand";
...
#define _PCD_TOKEN_PcdUefiFileHandleLibPrintBufferSize  194U
...
#define _PCD_TOKEN_PcdShellLibAutoInitialize  214U
...
#define _PCD_TOKEN_PcdShellPrintBufferSize  218U
...
{
  return LinuxInitrdDynamicShellCommandEntryPoint (ImageHandle, SystemTable);
}
...
{
  return LinuxInitrdDynamicShellCommandUnload (ImageHandle);
}
