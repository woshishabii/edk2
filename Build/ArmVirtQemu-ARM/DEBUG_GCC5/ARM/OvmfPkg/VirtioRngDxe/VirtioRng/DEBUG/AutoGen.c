...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x58E26F0D, 0xCBAC, 0x4BBA, {0xB7, 0x0F, 0x18, 0x22, 0x14, 0x15, 0x66, 0x5A}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VirtioRngDxe";
...
{
  return VirtioRngEntryPoint (ImageHandle, SystemTable);
}
