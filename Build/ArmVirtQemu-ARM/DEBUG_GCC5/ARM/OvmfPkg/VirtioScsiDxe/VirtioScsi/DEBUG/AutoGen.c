...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xFAB5D4F4, 0x83C0, 0x4AAF, {0x84, 0x80, 0x44, 0x2D, 0x11, 0xDF, 0x6C, 0xEA}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VirtioScsiDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdVirtioScsiMaxTargetLimit = _PCD_VALUE_PcdVirtioScsiMaxTargetLimit;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdVirtioScsiMaxLunLimit = _PCD_VALUE_PcdVirtioScsiMaxLunLimit;
...
{
  return VirtioScsiEntryPoint (ImageHandle, SystemTable);
}
