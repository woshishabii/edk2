...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xdce1b094, 0x7dc6, 0x45d0, {0x9f, 0xdd, 0xd7, 0xfc, 0x3c, 0xc3, 0xe4, 0xef}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "QemuRamfbDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gQemuRamfbGuid = {0x557423a1, 0x63ab, 0x406c, {0xbe, 0x7e, 0x91, 0xcd, 0xbc, 0x08, 0xc4, 0x57}};
...
{
  return InitializeQemuRamfb (ImageHandle, SystemTable);
}
