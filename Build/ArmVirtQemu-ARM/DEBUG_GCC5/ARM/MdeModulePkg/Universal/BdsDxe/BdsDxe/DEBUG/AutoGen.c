...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFdtClientProtocolGuid = { 0xE11FACA0, 0x4710, 0x4C8E, { 0xA7, 0xA2, 0x01, 0xBA, 0xA2, 0x59, 0x1B, 0x4C } };
...
#define _PCD_TOKEN_PcdValidateOrderedCollection  203U
...
#define _PCD_TOKEN_PcdDriverHealthConfigureForm  87U
...
#define _PCD_TOKEN_PcdQemuBootOrderPciTranslation  242U
...
#define _PCD_TOKEN_PcdQemuBootOrderMmioTranslation  241U
...
#define _PCD_VALUE_PcdQemuBootOrderMmioTranslation  ((BOOLEAN)1U)
...
#define _PCD_TOKEN_PcdTerminalTypeGuidBuffer  58U
#define _PCD_VALUE_PcdTerminalTypeGuidBuffer  (VOID *)_gPcd_FixedAtBuild_PcdTerminalTypeGuidBuffer
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdTerminalTypeGuidBuffer[16] = {0x65, 0x60, 0xA6, 0xDF, 0x19, 0xB4, 0xD3, 0x11, 0x9A, 0x2D, 0x00, 0x90, 0x27, 0x3F, 0xC1, 0x4D};
extern const UINT8 _gPcd_FixedAtBuild_PcdTerminalTypeGuidBuffer[16];
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdTerminalTypeGuidBuffer = 16;
