...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x128FB770, 0x5E79, 0x4176, {0x9E, 0x51, 0x9B, 0xB2, 0x68, 0xA1, 0x7D, 0xD1}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PciHostBridgeDxe";
...
#define _PCD_TOKEN_PcdPciIoTranslation  14U
...
#define _PCD_TOKEN_PcdPciExpressBaseAddress  24U
...
#define _PCD_TOKEN_PcdPciDisableBusEnumeration  16U
...
#define _PCD_TOKEN_PcdPciMmio32Translation  51U
...
#define _PCD_VALUE_PcdPciMmio32Translation  0x0ULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPciMmio32Translation = _PCD_VALUE_PcdPciMmio32Translation;
...
#define _PCD_TOKEN_PcdPciMmio64Translation  52U
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPciMmio64Translation = _PCD_VALUE_PcdPciMmio64Translation;
  ...
  )
{
  ...
  Status = FdtPciPcdProducerLibConstructor ();
  ASSERT_RETURN_ERROR (Status);
  ...
  Status = PciExpressLibInitialize ();
  ASSERT_RETURN_ERROR (Status);
...
{
  return InitializePciHostBridge (ImageHandle, SystemTable);
}
