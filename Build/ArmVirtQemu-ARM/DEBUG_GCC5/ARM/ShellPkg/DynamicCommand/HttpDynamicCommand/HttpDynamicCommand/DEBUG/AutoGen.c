...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x19618BCE, 0x55AE, 0x09C6, {0x37, 0xE9, 0x4C, 0xE0, 0x40, 0x84, 0xC7, 0xA1}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "httpDynamicCommand";
...
{
  return HttpCommandInitialize (ImageHandle, SystemTable);
}
