...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x168D1A6E, 0xF4A5, 0x448A, {0x9E, 0x95, 0x79, 0x56, 0x61, 0xBB, 0x30, 0x67}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ArmPciCpuIo2Dxe";
...
{
  return ArmPciCpuIo2Initialize (ImageHandle, SystemTable);
}
