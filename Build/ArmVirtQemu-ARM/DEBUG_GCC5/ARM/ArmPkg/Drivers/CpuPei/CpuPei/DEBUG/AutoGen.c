...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2FD8B7AD, 0xF8FA, 0x4021, {0x9F, 0xC0, 0x0A, 0xA5, 0x72, 0x14, 0x7C, 0xDC}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuPei";
...
{
  return InitializeCpuPeim (FileHandle, PeiServices);
}
