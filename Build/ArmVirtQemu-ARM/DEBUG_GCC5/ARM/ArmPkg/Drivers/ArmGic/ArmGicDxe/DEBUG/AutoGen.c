...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDE371F7C, 0xDEC4, 0x4D21, {0xAD, 0xF1, 0x59, 0x3A, 0xBC, 0xC1, 0x58, 0x82}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ArmGicDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gHardwareInterruptProtocolGuid = { 0x2890B3EA, 0x053D, 0x1643, { 0xAD, 0x0C, 0xD6, 0x48, 0x08, 0xDA, 0x3F, 0xF1 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gHardwareInterrupt2ProtocolGuid = { 0x32898322, 0x2da1, 0x474a, { 0xba, 0xaa, 0xf3, 0xf7, 0xcf, 0x56, 0x94, 0x70 } };
  ...
  )
{
  ...
  Status = ArmVirtGicArchLibConstructor ();
  ASSERT_RETURN_ERROR (Status);
...
{
  return InterruptDxeInitialize (ImageHandle, SystemTable);
}
