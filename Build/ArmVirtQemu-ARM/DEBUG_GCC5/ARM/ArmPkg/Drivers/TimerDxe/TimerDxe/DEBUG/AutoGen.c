...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x49ea041e, 0x6752, 0x42ca, {0xb0, 0xb1, 0x73, 0x44, 0xfe, 0x25, 0x46, 0xb7}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ArmTimerDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTimerPeriod = _PCD_VALUE_PcdTimerPeriod;
  ...
  )
{
  ...
  Status = ArmVirtTimerFdtClientLibConstructor ();
  ASSERT_RETURN_ERROR (Status);
...
{
  return TimerInitialize (ImageHandle, SystemTable);
}
