...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x864E1CA8, 0x85EB, 0x4D63, {0x9D, 0xCC, 0x6E, 0x0F, 0xC9, 0x0F, 0xFD, 0x55}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SioBusDxe";
...
{
  return SioBusDxeDriverEntryPoint (ImageHandle, SystemTable);
}
