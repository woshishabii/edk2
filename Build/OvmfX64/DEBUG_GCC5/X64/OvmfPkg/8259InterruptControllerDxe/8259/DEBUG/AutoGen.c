...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x245CB4DA, 0x8E15, 0x4A1B, {0x87, 0xE3, 0x98, 0x78, 0xFF, 0xA0, 0x75, 0x20}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Legacy8259";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_Pcd8259LegacyModeMask = _PCD_VALUE_Pcd8259LegacyModeMask;
...
{
  return Install8259 (ImageHandle, SystemTable);
}
