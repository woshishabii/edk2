...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8c2487ea, 0x9af3, 0x11e3, {0xb9, 0x66, 0xb8, 0xac, 0x6f, 0x7d, 0x65, 0xe6}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "XenPvBlkDxe";
...
{
  return XenPvBlkDxeDriverEntryPoint (ImageHandle, SystemTable);
}
...
{
  return XenPvBlkDxeUnload (ImageHandle);
}
