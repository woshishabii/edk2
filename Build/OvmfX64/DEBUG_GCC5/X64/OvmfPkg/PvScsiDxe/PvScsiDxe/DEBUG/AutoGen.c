...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x30346B14, 0x1580, 0x4781, {0x87, 0x9D, 0xBA, 0x0C, 0x55, 0xAE, 0x9B, 0xB2}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PvScsiDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdPvScsiMaxLunLimit = _PCD_VALUE_PcdPvScsiMaxLunLimit;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdPvScsiMaxTargetLimit = _PCD_VALUE_PcdPvScsiMaxTargetLimit;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdPvScsiWaitForCmpStallInUsecs = _PCD_VALUE_PcdPvScsiWaitForCmpStallInUsecs;
...
{
  return PvScsiEntryPoint (ImageHandle, SystemTable);
}
