...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x565ec8ba, 0xa484, 0x11e3, {0x80, 0x2b, 0xb8, 0xac, 0x6f, 0x7d, 0x65, 0xe6}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "XenBusDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gXenBusProtocolGuid = {0x3d3ca290, 0xb9a5, 0x11e3, {0xb7, 0x5d, 0xb8, 0xac, 0x6f, 0x7d, 0x65, 0xe6}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gXenIoProtocolGuid = {0x6efac84f, 0x0ab0, 0x4747, {0x81, 0xbe, 0x85, 0x55, 0x62, 0x59, 0x04, 0x49}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdXenGrantFrames = _PCD_VALUE_PcdXenGrantFrames;
  ...
  )
{
  ...
  Status = XenHypercallLibConstruct ();
  ASSERT_RETURN_ERROR (Status);
...
{
  return XenBusDxeDriverEntryPoint (ImageHandle, SystemTable);
}
...
{
  return XenBusDxeUnload (ImageHandle);
}
