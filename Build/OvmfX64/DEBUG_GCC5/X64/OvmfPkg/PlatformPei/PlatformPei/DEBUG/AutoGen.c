...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSevEsWorkAreaSize = _PCD_VALUE_PcdSevEsWorkAreaSize;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCsmEnable = _PCD_VALUE_PcdCsmEnable;
