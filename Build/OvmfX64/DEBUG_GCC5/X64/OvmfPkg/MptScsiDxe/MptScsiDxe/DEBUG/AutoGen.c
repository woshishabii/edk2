...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2B3DB5DD, 0xB315, 0x4961, {0x84, 0x54, 0x0A, 0xFF, 0x3C, 0x81, 0x1B, 0x19}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MptScsiDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdMptScsiMaxTargetLimit = _PCD_VALUE_PcdMptScsiMaxTargetLimit;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdMptScsiStallPerPollUsec = _PCD_VALUE_PcdMptScsiStallPerPollUsec;
...
{
  return MptScsiEntryPoint (ImageHandle, SystemTable);
}
