...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x378D7B65, 0x8DA9, 0x4773, {0xB6, 0xE4, 0xA4, 0x78, 0x26, 0xA8, 0x33, 0xE1}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PcRtc";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdInitialValueRtcRegisterA = _PCD_VALUE_PcdInitialValueRtcRegisterA;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdInitialValueRtcRegisterB = _PCD_VALUE_PcdInitialValueRtcRegisterB;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdInitialValueRtcRegisterD = _PCD_VALUE_PcdInitialValueRtcRegisterD;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdRtcUseMmio = _PCD_VALUE_PcdRtcUseMmio;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdMinimalValidYear = _PCD_VALUE_PcdMinimalValidYear;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdMaximalValidYear = _PCD_VALUE_PcdMaximalValidYear;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdRtcIndexRegister = _PCD_VALUE_PcdRtcIndexRegister;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdRtcTargetRegister = _PCD_VALUE_PcdRtcTargetRegister;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdRtcIndexRegister64 = _PCD_VALUE_PcdRtcIndexRegister64;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdRtcTargetRegister64 = _PCD_VALUE_PcdRtcTargetRegister64;
...
#define _PCD_TOKEN_PcdPciExpressBaseSize  180U
  ...
  )
{
  ...
  Status = ReportStatusCodeLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  Status = ReportStatusCodeLibDestructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return InitializePcRtc (ImageHandle, SystemTable);
}
