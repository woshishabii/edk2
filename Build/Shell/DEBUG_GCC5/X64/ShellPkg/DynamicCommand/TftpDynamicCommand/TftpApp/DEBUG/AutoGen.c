...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8DC58D0D, 0x67F5, 0x4B97, {0x9D, 0xFC, 0xE4, 0x42, 0xBB, 0x9A, 0x56, 0x48}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "tftp";
...
{
  return TftpAppInitialize (ImageHandle, SystemTable);
}
