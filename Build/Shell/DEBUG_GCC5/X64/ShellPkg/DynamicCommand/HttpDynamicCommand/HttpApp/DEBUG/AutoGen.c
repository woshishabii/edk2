...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x56B00FB7, 0x91D2, 0x869B, {0xCE, 0x5C, 0x26, 0xCD, 0x1A, 0x89, 0xC7, 0x3C}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "http";
...
{
  return HttpAppInitialize (ImageHandle, SystemTable);
}
