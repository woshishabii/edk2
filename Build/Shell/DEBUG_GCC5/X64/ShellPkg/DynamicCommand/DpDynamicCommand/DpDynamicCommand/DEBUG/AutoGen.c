...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0253F9FA, 0x129A, 0x4A8D, {0xB1, 0x2E, 0x7D, 0xC2, 0xB6, 0x37, 0x63, 0x02}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "dpDynamicCommand";
...
{
  return DpCommandInitialize (ImageHandle, SystemTable);
}
