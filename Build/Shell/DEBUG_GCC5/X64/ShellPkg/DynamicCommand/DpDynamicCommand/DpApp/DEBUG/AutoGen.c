...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1831A379, 0x2D48, 0x45BD, {0x97, 0x44, 0xD4, 0x05, 0x9D, 0x93, 0x81, 0x5D}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "dp";
...
{
  return DpAppInitialize (ImageHandle, SystemTable);
}
